...
sender = UDP_Sender(mode=BROADCAST_MODE.UNICAST, addresses=["127.0.0.1"], port=9991)
cap = cv2.VideoCapture(r'C:\Users\User\Desktop\bfmc\frontendUDP\videos\85.mp4') # Putanja do tvog videa
#TARGET_FPS = 30
